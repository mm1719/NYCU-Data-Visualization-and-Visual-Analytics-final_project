...
sessionStorage.setItem("selectedGeo", "Oceania");
...
d3.json("./data/countries/OC/OC-topojson.json").then(function(geojson) {
    const countries = topojson.feature(geojson, geojson.objects.OC);
